...
function foodie_restaurant_global_color() {
	...
	';
    wp_add_inline_style( 'foodie-restaurant-style',$theme_color_css );
    wp_add_inline_style( 'foodie-restaurant-woocommerce-css',$theme_color_css );
...
if (!function_exists('foodie_restaurant_loop_columns')) {
	function foodie_restaurant_loop_columns() {
		$columns = get_theme_mod( 'foodie_restaurant_per_columns', 3 );
		return $columns;
	}
}
...
function foodie_restaurant_per_page( $cols ) {
  	$cols = get_theme_mod( 'foodie_restaurant_product_per_page', 9 );
	return $cols;
}
